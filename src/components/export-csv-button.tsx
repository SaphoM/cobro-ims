...
/**
 * Client-side CSV export — covers the RFQ's non-functional requirement
 * "All data exportable to Excel / CSV at any time; no data lock-in."
 * Excel opens CSV natively, so one export format satisfies both.
 */
